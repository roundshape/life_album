// カレンダー操作
const calendar_click = function() {
  document.querySelectorAll('.event-icon').forEach(function(element) {
...
window.addEventListener("turbo:load", calendar_click);
window.addEventListener("turbo:render", calendar_click);
